window.DASH_CONTENT = {
  ...
  working: [
    ...
    'Tarot listing pages: purchases keep growing with traffic (122 people in August, 145 so far in September) while conversion holds at about 0.65%.',
  ...
  watch: [
    ...
    'Tarot listing pages: the card-click rate fell from 16.9% to 10.9% between August and September, and fewer people who ask a leader a question go on to buy (33.9% to 25.3%). Overall conversion held, so the two roughly offset.',
  ...
  takeaways: {
    'tarot-all-all': 'Traffic ramped up from 3,044 people in July to 17,757 in August and 21,929 so far in September. Purchases grew with it (51, then 122, then 145 people), but conversion settled at about 0.65% after a 1.8% launch month with a small early audience. Card clicks fell from 16.9% in August to 10.9% in September, while more people ask a leader a question (1.9% to 2.2%) and fewer of those go on to buy (33.9% to 25.3%).',
  ...
  notes: [
    ...
    'The chip next to each number compares the two months. Green Improved or red Declined means the change is statistically real (95% confidence) and at least 5% different in relative terms. A grey arrow (for example “Up +2.0 pts, not yet significant”) means the number moved by at least 5% but could still be noise, which is common on small audiences. “No clear change” means it moved less than that, and “Too few people to tell” means fewer than 30 people in one of the months. The test is rough and leans slightly optimistic, because repeat visitors are not independent.',
    'Each small chart has its own scale that starts at zero, so compare shapes, not heights, between charts.',
    'The Tarot listing report only started collecting on 29 June, so earlier months are left blank. Its overall conversion is the report’s Absolute CR; the small step-by-step charts show card clicks, leader queries and purchases after a leader query.',
